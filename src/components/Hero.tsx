...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="pt-28 min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-orange-900 flex items-center justify-center relative overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        <p className="text-xl mb-6 animate-fade-in delay-300 text-emerald-400 font-medium md:text-2xl">
        ...
        <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8 leading-relaxed animate-fade-in delay-500">
          A passionate software developer with a strong interest in Backend Development. I’m driven by curiosity and a constant desire to learn and grow in the ever-evolving world of technology.
        </p>
        ...
        <div className="flex justify-center space-x-6 mb-12 animate-fade-in delay-1000">
          <a
            href="https://linkedin.com/in/dev-aman-kr17/"
            target="_blank"
          ...
          <a
            href="mailto:amankr1705@gmail.com"
            className="text-gray-400 hover:text-orange-500 transition-all duration-300 hover:scale-110"
          >
            <Mail size={24} />
          </a>
